...
const StrategicPlanning = () => {
  ...
  return (
    <Container>
      <h1>{title}</h1>
      <img
        src="/images/services/data-strategy/hero.jpeg"
        alt="lets build together"
      />

      <Row>
        <Col>
          <blockquote className="blockquote" style={{ marginTop: "0px" }}>
      ...
      <Row style={{ marginLeft: 0 }}>
        ...
        <Col md={6}>
          <img src="/images/vectors/talking_on_phone.jpg" alt="Eval image" />
        </Col>
      </Row>
